...
def test_publisher(results_publishinfo):
    with ACBFBook(results_publishinfo / "test_publisher.acbf", 'w', archive_type=None) as book:
...
def test_publish_date(results_publishinfo):
    with ACBFBook(results_publishinfo / "test_publish_date.acbf", 'w', archive_type=None) as book:
...
def test_publish_date_excl(results_publishinfo):
    with ACBFBook(results_publishinfo / "test_publish_date_excl.acbf", 'w', archive_type=None) as book:
...
def test_city(results_publishinfo):
    with ACBFBook(results_publishinfo / "test_city.acbf", 'w', archive_type=None) as book:
...
def test_isbn(results_publishinfo):
    with ACBFBook(results_publishinfo / "test_isbn.acbf", 'w', archive_type=None) as book:
...
def test_license(results_publishinfo):
    with ACBFBook(results_publishinfo / "test_license.acbf", 'w', archive_type=None) as book:
