...
def add_reference(book: ACBFBook, id: str, paragraph: str, idx: int = -1):
	...
	"""
	_check_book(book)
	ref_section = _check_reference_section()
...
def remove_reference(book: ACBFBook, id: str):
	...
	"""
	_check_book(book)
	ref_section = _check_reference_section(False)
...
def add_data(book: ACBFBook, file_path: str):
	...
	"""
	_check_book(book)
	dat_section = _check_data_section()
...
def remove_data(book: ACBFBook, id: str):
	...
	"""
	_check_book(book)
	dat_section = _check_data_section(False)
